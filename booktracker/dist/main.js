...
var AddBookComponent = /** @class */ (function () {
    ...
    AddBookComponent.prototype.saveBook = function (formValues) {
        ...
        newBook.bookID = 0;
        console.log(newBook);
        this.dataService.addBook(newBook).subscribe(function (book) { return console.log(book); }, function (error) { return console.log(error); });
    };
...
/* harmony import */ var _core_book_resolver_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./core/book-resolver.service */ "./src/app/core/book-resolver.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'dashboard', component: app_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], resolve: {
            resolvedBooks: _core_book_resolver_service__WEBPACK_IMPORTED_MODULE_7__["BooksResolverService"]
        } },
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getAllBooks = function () {
        ...
        return this.http.get('/api/books')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) { return _this.handleHttpError(error); }));
    };
    ...
    DataService.prototype.getBookById = function (id) {
        var httpHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
    ...
    DataService.prototype.getOldBookById = function (id) {
        return this.http.get("/api/books/" + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (book) { return ({
            bookTitle: book.title,
            year: book.publicationYear
        }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (oldBook) { return console.log('data service:', oldBook); }));
    };
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        // ***************
        // use resolver and data is passed in by the routing service
        // ***************
        // this.dataService.getAllBooks().subscribe(
        //   (books: Book[]) => this.allBooks = books,
        //   (error: any) => console.log(error),
        //   () => console.log('Complete getting all the books')
        // )
...
var EditBookComponent = /** @class */ (function () {
    ...
    EditBookComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getBookById(bookID)
            .subscribe(function (book) { return _this.selectedBook = book; }, function (error) { return console.log(error); }, function () { return console.log('Getting book by id completed'); });
        this.dataService.getOldBookById(bookID)
            .subscribe(function (book) { return console.log('edit book', book); });
    };
...
module.exports = __webpack_require__(/*! /Users/tsunarto/Codes/Learning_Angular/booktracker/src/main.ts */"./src/main.ts");
