...
USE master
GO
if exists (select * from sysdatabases where name='SecuringAngularApps')
		drop database SecuringAngularApps
go
...
EXECUTE (N'CREATE DATABASE SecuringAngularApps
  ON PRIMARY (NAME = N''SecuringAngularApps'', FILENAME = N''' + @device_directory + N'SecuringAngularApps.mdf'')
  LOG ON (NAME = N''SecuringAngularApps_log'',  FILENAME = N''' + @device_directory + N'SecuringAngularApps.ldf'')')
go

if exists (select * from sysdatabases where name='SecuringAngularAppsSTS')
		drop database SecuringAngularAppsSTS
go
...
EXECUTE (N'CREATE DATABASE SecuringAngularAppsSTS
  ON PRIMARY (NAME = N''SecuringAngularAppsSTS'', FILENAME = N''' + @device_directory + N'SecuringAngularAppsSTS.mdf'')
  LOG ON (NAME = N''SecuringAngularAppsSTS_log'',  FILENAME = N''' + @device_directory + N'SecuringAngularAppsSTS.ldf'')')
go
...
Run this script on BRIANSP5.SecuringAngularApps2 (BRIANSP5\brian) to make it the same as BRIANSP5.SecuringAngularApps (BRIANSP5\brian).
...
INSERT INTO [dbo].[UserProfiles] ([Id], [Email], [FirstName], [HasLoggedIn], [LastName]) VALUES (N'34a2101b-3f25-4a2d-87d2-ca7adb3feb11', N'bob@globomatics.com', N'Bob', 0, N'Roberts')
INSERT INTO [dbo].[UserProfiles] ([Id], [Email], [FirstName], [HasLoggedIn], [LastName]) VALUES (N'510df9ac-baca-43b6-9e4a-cdda5f419428', N'alice@outlook.com', N'Alice', 0, N'Allison')
INSERT INTO [dbo].[UserProfiles] ([Id], [Email], [FirstName], [HasLoggedIn], [LastName]) VALUES (N'91dd93b1-403c-4913-b7fe-917bb0c35996', N'mary@globomatics.com', N'Mary', 0, N'Marisette')
...
INSERT INTO [dbo].[AspNetUsers] ([Id], [AccessFailedCount], [ConcurrencyStamp], [Email], [EmailConfirmed], [LockoutEnabled], [LockoutEnd], [NormalizedEmail], [NormalizedUserName], [PasswordHash], [PhoneNumber], [PhoneNumberConfirmed], [SecurityStamp], [TwoFactorEnabled], [UserName]) VALUES (N'34a2101b-3f25-4a2d-87d2-ca7adb3feb11', 0, N'6bc7ef72-085f-4b60-a3d8-1f45f1c7cee4', N'bob@globomatics.com', 0, 1, NULL, N'BOB@GLOBOMATICS.COM', N'BOB@GLOBOMATICS.COM', N'AQAAAAEAACcQAAAAEMUOON4JcDDL23xTLbpuR9HC2O9uie1jqcvyMN3SwOWrNudevSBnoFeUorNdIZEUkA==', NULL, 0, N'd6ec7b4a-ce49-4376-8721-989c97776e78', 0, N'bob@globomatics.com')
...
INSERT INTO [dbo].[AspNetUsers] ([Id], [AccessFailedCount], [ConcurrencyStamp], [Email], [EmailConfirmed], [LockoutEnabled], [LockoutEnd], [NormalizedEmail], [NormalizedUserName], [PasswordHash], [PhoneNumber], [PhoneNumberConfirmed], [SecurityStamp], [TwoFactorEnabled], [UserName]) VALUES (N'91dd93b1-403c-4913-b7fe-917bb0c35996', 0, N'd7c42f8d-477d-49fe-ae4f-7b4301985acd', N'mary@globomatics.com', 0, 1, NULL, N'MARY@GLOBOMATICS.COM', N'MARY@GLOBOMATICS.COM', N'AQAAAAEAACcQAAAAEAo6Wp95tWLS9RAPHrv0CmqkYk3Nio/Dxl0hjyx+i1CRA2jByJ6uQbyrW8e1wFVcfA==', NULL, 0, N'a95f50c2-7c3b-499e-ac70-13b3849b0e8f', 0, N'mary@globomatics.com')
